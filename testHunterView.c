...
int main(void)
{
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Testing Dracula doubling three turns back to Castle Dracula\n");
	...
	{///////////////////////////////////////////////////////////////////
		...
		printf("Checking other connection functions for Godalming in Paris"
		       "(Godalming, Round 2)\n"
			   "(HvWhereCanIGoByType)\n");
	...
	{///////////////////////////////////////////////////////////////////
		...
		int numLocs = -1;
		PlaceId *locs = HvWhereCanTheyGoByType(hv, PLAYER_LORD_GODALMING, true, true, true, &numLocs);
		assert(numLocs == 9);
		sortPlaces(locs, numLocs);
		assert(locs[0] == BORDEAUX);
		assert(locs[1] == BRUSSELS);
